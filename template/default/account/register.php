...
<div class="loginForm">
	...
	<div class="card">
		<div class="card-header" style="padding:20px; padding-left: 50px; padding-right: 50px; ">
			<h4><i class="fas fa-unlock fa-icon"></i> <?php echo lang("register_title");?></h4>
		...
		<div class="card-body" style="padding:50px;">
			...
			<?php echo form_open(site_url("register.html"));?>
			...
			<div class="input-group mb-3">
			  ...
			  <div class="row">
			  	<div class="col">
			  		<label class="form-check-label" for="exampleCheck1"><input type="checkbox" name="remember"> <?php echo lang("remember");?></label>
			  	</div>

			  	<div class="col text-right">
			  		<a class="form-check-label" for="exampleCheck1" href="<?php echo site_url("forget.html");?>"><?php echo lang("forget");?></a>
			  	</div>
